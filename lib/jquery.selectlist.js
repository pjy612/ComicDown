    ...
    SelectList.prototype={
        ...
        setSelectEvent: function(element){
            ...
            if(that.settings.enable){
	            //var key13_select=null;
                $(selectID)
                    .click(function(event){
                        event.stopPropagation();
                        
                        
                        if($(this).children('.select-list:hidden').length){
                    ...
                    .on('keyup','input[type="button"]',function(event){
                        ...
                        switch(event.keyCode){
                            //Enter
                            case 13:
                            	var pre_val=$(this).prev().prev().val();
                                ...
                                if ($.isFunction(that.settings.onChange)) {
                                    that.settings.onChange.call(that,pre_val,$selectedItem.attr('data-value'));
                                }
                                break;
                            //Esc
                            case 27:
                            ...
                            case 38:
                                ...
                                //key13_select =  $(this).siblings('.select-list').children().children('li.selected');
                                //$(this)
                                //    .val($selectedItem.text())
                                //    .prev().prev().val($selectedItem.attr('data-value'));
                                break;
                            ...
                            case 40:
                                event.preventDefault();
                                if(selectedIndex >= selectLength - 1) return;
                ...
                selectItem.on('click',function(event){
                    event.stopPropagation();   
                    var pre_Val=$(this).parent().parent().prev().prev().prev().val();     
                    $(this)
                    ...
                    if($.isFunction(that.settings.onChange)){
                        that.settings.onChange.call(that,pre_Val,$(this).attr('data-value'));
                    }

                    return false;
                }).hover(function(){
                    $(this).addClass('selected').siblings().removeClass('selected');
                    selectedIndex = $(this).parent().find('li').index($(this));
